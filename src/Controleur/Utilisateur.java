...
class Utilisateur extends JPanel {
	...
	protected boolean joueur_actif = false; //declencheur pour savoir si le jour est actif ou non comme ça on peut manipuler la gestion de jeu
	protected int touchee = -1; //un entier pour savoir si la case de l'utilisateur est touchée ou non (touchée contient un bateau = 1 & touchée contient pas de bateau = 0 & initialisation = -1)
	private int id ;
	protected String nom;
	protected Grille g; // la grille de l'utilisateur
	private int num_bateau = 0; // indice de bateau pendant la creation chaque bateau crée num_bateau++
